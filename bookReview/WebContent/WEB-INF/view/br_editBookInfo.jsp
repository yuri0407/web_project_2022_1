        ...
        <div class="content">
            ...
            <form action="br_managerBookList.jsp" method="post">
                ...
                <table>
                    <tr>
                        <td>도서명</td>
                        <td><input type="text" name="mNum" class="textbox" value="the midnight library"></td>
                    </tr>
                    
                    <tr>
                        <td>저자</td>
                        <td><input type="text" name="id" class="textbox" value="Hait, matt"></td>
                    </tr>
                    
                    <tr>
                        <td>출판사</td>
                        <td><input type="text" name="pwd" class="textbox" value="Cannongate"></td>
                    </tr>

                    <tr>
                        <td>출판일</td>
                        <td><input type="text" name="pwd" class="textbox" value="2021-02-18"></td>
                    </tr>
                    ...
                    <tr>
                    <td>도서 설명</td>
                    <td><textarea name = "detail" rows="4" cols="">
...
현재 덴마크, 이탈리아, 스페인, 루마니아, 타이완, 이란 등 세계 각지에서 출간되며 글로벌한 인기를 누리고 있다.
                    ...
                    <tr>
                        ...
                        <td class="btn">
                            ...
                            <button onclick="location.href='br_managerBookList.jsp'">삭제하기</button>
                        </td>
                    </tr>
                </table>
