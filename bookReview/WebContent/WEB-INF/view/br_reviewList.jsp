...
<body>
	...
	<div class="content">
		...
		<div class="search">			
			...
			<button>검색</button>
			<button onclick="location.href='br_writeReview.jsp'">리뷰등록</button>
		</div>
		...
		<div class="tablearea">
			<table>
				...
				<tr class="row">
					...
					<td>우리의 모든 what if 경우들을 생각해보게 된다. 내가 이랬다면, 저랬다면. 캐릭터랑 서사가 어렵지 않아서 주인공이 물리학,철학 이야기하는 부분도 이해가 잘 됩니다.
